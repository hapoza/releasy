...
module.exports = function(opts) {
  ...
  config.tagName = `${opts.tagPrefix}v${config.newVersion}`
  config.commitMessage = `${opts.msgPrefix}Release ${config.tagName}`
  config.tagMessage = `${opts.msgPrefix}Release ${config.tagName}`
